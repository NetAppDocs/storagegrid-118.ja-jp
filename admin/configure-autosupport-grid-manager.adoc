...
* https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/configuring-snmp-settings-for-bmc.html["BMCのSNMP設定を行います"^] SG6000-CNコントローラ、またはSG100およびSG1000サービスアプライアンスの場合
