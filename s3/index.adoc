...
11.8
 a| 
S3処理の名前がで使用されている名前に更新されました。 http://docs.aws.amazon.com/AmazonS3/latest/API/Welcome.html["Amazon Web Services （ AWS ）ドキュメント：「 Amazon Simple Storage Service API Reference"^]。
